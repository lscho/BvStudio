...
const WALL_UP = [6, 22] as const;
const FLIGHT = [10, 54] as const;
const CARD_OUT = [62, 72] as const;
const RING_T0 = 70;
const TEXT_T0 = 84;
        ...
        return (
          ...
          >
            {Array.from({ length: 4 }).map((_, i) => (
              ...
              >
                {contentText(content, "copy0", "FASTER")}</span>
            ))}
          </div>
        );
      })}
...
const CARDS: { title: string; k: [Pose, Pose, Pose]; conv: Pose }[] = [
  {
    title: contentText(content, "copy1", "Inbox"),
    k: [
  ...
  {
    title: contentText(content, "copy2", "List view"),
    k: [
  ...
  {
    title: contentText(content, "copy3", "Home"),
    k: [
...
const CardFlockTumble: React.FC = () => {
        ...
        <AbsoluteFill style={{ justifyContent: 'center', alignItems: 'center' }}>
          ...
          >
            ...
            <text
              ...
              strokeWidth={4.5}
            >
              {contentText(content, "copy4", "STRONGER")}</text>
          </svg>
        </AbsoluteFill>
      )}
    </AbsoluteFill>
