    ...
    >
      ...
      >
        ...
        <div style={{ position: 'absolute', left: 120, top: 96 }}>
          <TitleBlock text={contentText(content, "copy0", "SCORE SLAM")} size={54} />
        </div>
        ...
        {frame >= 8 && (
          ...
          >
            ...
            >
              {contentText(content, "copy1", "+247%")}</div>
            <div
              style={{
                fontFamily: 'Helvetica, Arial, sans-serif',
                fontWeight: 600,
            ...
            >
              {contentText(content, "copy2", "QUARTERLY GROWTH")}</div>
          </div>
        )}
      </div>
    </div>
