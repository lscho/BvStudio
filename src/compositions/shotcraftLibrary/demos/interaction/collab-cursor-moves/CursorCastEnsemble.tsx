...
const ACTORS: Actor[] = [
  { name: contentText(content, "copy0", "Lisa"), color: '#4C8DF6', from: [-160, 200], home: [430, 330], delay: 0, phase: 0.0 },
  { name: contentText(content, "copy1", "Lucas"), color: '#2FBF71', from: [2080, 160], home: [1370, 290], delay: 5, phase: 1.7 },
  { name: contentText(content, "copy2", "Marta"), color: '#F2994A', from: [-160, 900], home: [560, 760], delay: 9, phase: 3.1 },
  { name: contentText(content, "copy3", "Niko"), color: '#4C8DF6', from: [2080, 950], home: [1420, 780], delay: 13, phase: 4.4 },
  { name: contentText(content, "copy4", "Rita"), color: '#2FBF71', from: [900, -180], home: [960, 545], delay: 17, phase: 5.6 },
];
...
const CursorCastEnsemble: React.FC = () => {
