...
const DIM_START = 15;
const PANEL_IN = 22;
const TYPE_FRAMES = [38, 46, 54, 62];
const ENTER = 68;
const RIPPLE = 73;
const RIPPLE_END = 95;
const ORIGIN = { x: 960, y: 470 };
const MAX_R = 1250;
const D = {
...
const PaletteThemeRipple: React.FC = () => {
      ...
      {panelMounted && (
        ...
        >
          ...
          <div style={{ height: 62, border: `2px solid ${G.line}`, borderRadius: 12, display: 'flex', alignItems: 'center', gap: 14, padding: '0 18px', boxSizing: 'border-box' }}>
            <div style={{ padding: '6px 12px', borderRadius: 8, background: G.side, color: '#fff', fontFamily: 'Helvetica, Arial, sans-serif', fontWeight: 800, fontSize: 22 }}>{contentText(content, "copy0", "⌘K")}</div>
            {TYPE_FRAMES.map((_, i) => (
