...
import { AbsoluteFill, useCurrentFrame, interpolate, spring, useVideoConfig, Easing } from "@/compositions/shotcraftLibrary/runtime";
...
const GROW_END = 52;
const HOLD_END = 66;
const AutolayoutGapDial: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: G.bg, overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', top: 250, width: '100%', textAlign: 'center', fontFamily: 'Helvetica, Arial, sans-serif', fontWeight: 800, fontSize: 44, color: G.mid, letterSpacing: 2 }}>
        {contentText(content, "copy0", "GAP")}<span style={{ display: 'inline-block', minWidth: 130, marginLeft: 24, padding: '4px 22px', borderRadius: 12, background: G.ink, color: '#f2f2f0', fontVariantNumeric: 'tabular-nums', transform: `scale(${tickPulse})` }}>
          {gapShown}
        </span>
      </div>
