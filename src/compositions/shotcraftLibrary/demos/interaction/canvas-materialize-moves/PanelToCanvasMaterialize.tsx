...
const CARD_W = 480;
const CARD_H = 240;
const CHECK_FRAMES = [12, 22, 32];
const BUTTON_FRAME = 46;
const FLY_START = [54, 60, 66];
const PanelToCanvasMaterialize: React.FC = () => {
      ...
      >
        ...
        >
          <div style={{ fontFamily: 'Helvetica, Arial, sans-serif', fontWeight: 700, fontSize: 22, color: '#f2f2f0', letterSpacing: 0.5 }}>
            {contentText(content, "copy0", "Add all to canvas")}</div>
        </div>
      </div>
...
return PanelToCanvasMaterialize;
}
