...
const PROMPT = contentText(content, "copy0", "Generate an entity-relationship diagram");
const TYPE_START = 6;
const TYPE_CPS = 1.1;
const NODE_W = 300;
const NODE_H = 110;
...
const DiagramCascadeBuild: React.FC = () => {
