...
const TC = 1, TR = 1;
const LABELS = [contentText(content, "copy0", "JD"), contentText(content, "copy1", "MK"), contentText(content, "copy2", "CD"), contentText(content, "copy3", "RL"), contentText(content, "copy4", "AV"), contentText(content, "copy5", "TP"), contentText(content, "copy6", "KN"), contentText(content, "copy7", "BW"), contentText(content, "copy8", "CE"), contentText(content, "copy9", "HR"), contentText(content, "copy10", "LM"), contentText(content, "copy11", "DQ")];
...
const PW0 = CW, PW1 = 190;
const NAME_CHARS = 'Casey Doe'.split('');
...
const ChipLiftToUserPill: React.FC = () => {
  const t = useT();
      ...
      >
        <div style={{ position: 'absolute', left: '50%', top: '50%', width: 440, height: 240, margin: '-120px 0 0 -220px' }}>
          ...
          >
            ...
            >
              {contentText(content, "copy2", "CD")}</div>
