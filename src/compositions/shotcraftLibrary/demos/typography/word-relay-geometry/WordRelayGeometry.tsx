...
const SLOTS: { label: string; geom: Geom[]; t0: number; t1: number }[] = [
  { label: contentText(content, "copy0", "Faster"), geom: [{ x: 0, r: CIRC_R + 22, dash: true }], t0: 0.0, t1: 0.36 },
  {
    label: contentText(content, "copy1", "Better"),
    geom: [
      { x: -110, r: 62, d: 0 },
      { x: 0, r: 62, d: 0.06 },
      { x: 110, r: 62, d: 0.12 },
  ...
  { label: contentText(content, "copy2", "Stronger"), geom: [], t0: 0.64, t1: 1.0 },
];
const WordRelayGeometry: React.FC = () => {
  const t = useT();
  return (
