...
const PAD = 34;
const FOCUS_X = 960;
const FOCUS_Y = TT + TITLEBAR + PAD + 92;
const TerminalWindow: React.FC<{ chars: number; cursorOn: boolean }> = ({ chars, cursorOn }) => (
  <div style={{
    ...
    <div style={{
      ...
      {/* 一行历史输出做上下文 */}
      <div style={{ color: '#7a7a78', fontSize: 32, marginBottom: 18 }}>{contentText(content, "copy0", "~/acme-app (main)")}</div>
