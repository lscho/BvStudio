...
const TOTAL = 5.6 * 30;
const GAP = 10;
const CELL_W = (480 - 32 - (COLS - 1) * GAP) / COLS;
const CELL_H = (270 - 32 - (ROWS - 1) * GAP) / ROWS;
...
const AvatarGridRadialBuildColorize: React.FC = () => {
  const t = useT();
  ...
  return (
    <DesignStage bg={PAPER} raster="zoom">
      ...
      >
        ...
        >
          {contentText(content, "copy0", "Let's bring them back in")}</div>
        <div
          style={{
            position: 'absolute',
            left: '50%',
...
return AvatarGridRadialBuildColorize;
}
