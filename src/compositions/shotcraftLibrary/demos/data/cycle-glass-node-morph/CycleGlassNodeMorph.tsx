...
import { interpolate, useCurrentFrame } from "@/compositions/shotcraftLibrary/runtime";
import { DesignStage, E, lerp } from '@/compositions/shotcraftLibrary/demos/_fixtures/Motion';
...
const CycleGlassNodeMorph: React.FC = () => {
  ...
  const labelData = [
    { label: contentText(content, "copy0", "SENSE"), left: 147, top: 92, start: 124 },
    { label: contentText(content, "copy1", "MODEL"), left: 240, top: 63, start: 129 },
    { label: contentText(content, "copy2", "ACT"), left: 333, top: 92, start: 134 },
  ];
  ...
  return (
    <DesignStage bg="#f5f5f2" raster="zoom">
      ...
      >
        ...
        >
          {contentText(content, "copy3", "CONTEXT")}</div>
        ...
        >
          {contentText(content, "copy4", "SYSTEM LOOP")}</div>
        ...
        >
          ...
          <text
            ...
            fontWeight="850"
          >
            {contentText(content, "copy5", "SUBJECT")}</text>
        </svg>
        ...
        >
          ...
          <GlassNode frame={frame} start={184} end={192} left={92} top={98} label={contentText(content, "copy0", "SENSE")} />
          <GlassNode frame={frame} start={192} end={200} left={185} top={69} label={contentText(content, "copy1", "MODEL")} />
          <GlassNode frame={frame} start={200} end={208} left={278} top={98} label={contentText(content, "copy2", "ACT")} />
