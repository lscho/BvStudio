...
const AxisRescaleShockV2: React.FC = () => {
  ...
  return (
    <div style={{ width: 1920, height: 1080, background: G.bg, position: 'relative', overflow: 'hidden' }}>
      <div style={{ position: 'absolute', top: 100, width: '100%', textAlign: 'center' }}>
        <TitleBlock text={contentText(content, "copy0", "AXIS RESCALE SHOCK V2")} size={72} />
      </div>
      ...
      >
        ...
        <div style={{ position: 'absolute', left: PAD, top: 34, fontFamily: 'Helvetica, Arial, sans-serif' }}>
          <div style={{ fontSize: 30, fontWeight: 700, color: G.ink }}>{contentText(content, "copy1", "Monthly revenue")}</div>
          <div style={{ fontSize: 19, fontWeight: 500, color: G.mid, marginTop: 6 }}>{contentText(content, "copy2", "FY2026 · all products · USD")}</div>
        </div>
        ...
        <div style={{ position: 'absolute', left: PLOT_X, top: PLOT_Y, width: PLOT_W, height: PLOT_H }}>
          ...
          <div style={{ position: 'absolute', left: -AXIS_W, top: PLOT_H - 13, width: AXIS_W - 14, fontFamily: 'Helvetica', fontWeight: 700, fontSize: 21, color: G.mid, textAlign: 'right' }}>{contentText(content, "copy3", "$0")}</div>
          ...
          {valS > 0 && (
            ...
            >
              {contentText(content, "copy4", "$340k")}</div>
          )}
