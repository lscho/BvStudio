...
const PANEL_H = 560;
const BAR_COUNT = 5;
const BulletTimeFreezeOrbit: React.FC = () => {
  ...
  return (
    ...
    >
      <div style={{ position: 'absolute', top: 56, left: 72 }}>
        <TitleBlock text={contentText(content, "copy0", "BULLET TIME")} size={44} />
      </div>
      ...
      >
        {contentText(content, "copy1", "FREEZE")}</div>
