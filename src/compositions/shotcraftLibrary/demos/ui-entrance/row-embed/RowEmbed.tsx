...
import { interpolate, useShotcraftContent, shotcraftImageUrl, useCurrentFrame, Easing } from "@/compositions/shotcraftLibrary/runtime";
...
const RowEmbed: React.FC = () => {
  const frame = useCurrentFrame();
  const detailSrc = shotcraftImageUrl(useShotcraftContent(), "textures/live/detail-full.png");
