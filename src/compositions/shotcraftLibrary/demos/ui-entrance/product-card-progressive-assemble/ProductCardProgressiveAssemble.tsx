...
const LINES: [string, boolean?][][] = [
  [[contentText(content, "copy0", "Placeholder copy for ")], [contentText(content, "copy1", "a key highlight"), true], [contentText(content, "copy2", " in the")]],
  [[contentText(content, "copy3", "product body. ")], [contentText(content, "copy4", "Second highlight"), true], [contentText(content, "copy5", " sits here on")]],
  [[contentText(content, "copy6", "the third line of neutral sample text.")]],
];
const ProductCardProgressiveAssemble: React.FC = () => {
  const t = useT();
  // 整卡呼吸前推
      ...
      >
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
          ...
          <div style={{ fontSize: 19, fontWeight: 800, color: '#17181c', letterSpacing: '-.3px', ...fieldStyle(t, 4) }}>
            {contentText(content, "copy7", "Sample Product Title")}</div>
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 9, marginBottom: 11, ...fieldStyle(t, 16) }}>
            ...
            >
              {contentText(content, "copy8", "$249")}</span>
            <span
              style={{
                fontSize: 21,
                fontWeight: 800,
            ...
            >
              {contentText(content, "copy9", "$189")}</span>
          </div>
...
return ProductCardProgressiveAssemble;
}
