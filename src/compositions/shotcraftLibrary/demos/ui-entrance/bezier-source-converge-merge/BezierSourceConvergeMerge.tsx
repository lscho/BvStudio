...
const XC = 332, YC = 120;
const SRCS = [
  { y: 36, tag: contentText(content, "copy0", "S1"), c: '#111111' },
  { y: 92, tag: contentText(content, "copy1", "S2"), c: '#4A4A50' },
  { y: 148, tag: contentText(content, "copy2", "S3"), c: '#7A7A82' },
  { y: 204, tag: contentText(content, "copy3", "S4"), c: '#A3A3AA' },
];
...
const BezierSourceConvergeMerge: React.FC = () => {
  const t = useT();
...
return BezierSourceConvergeMerge;
}
