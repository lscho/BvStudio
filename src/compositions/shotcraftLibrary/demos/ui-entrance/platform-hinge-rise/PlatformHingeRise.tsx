...
const SubjectPanel: React.FC<{
  ...
  return (
    ...
    >
      {contentText(content, "copy0", "SUBJECT")}</div>
  );
};
const PlatformHingeRise: React.FC = () => {
  ...
  return (
    <DesignStage bg="#f4f4f1" raster="zoom">
      ...
      >
        ...
        >
          {contentText(content, "copy1", "CONTEXT")}</div>
        ...
        >
          {contentText(content, "copy2", "OUTCOME")}</div>
      </div>
    </DesignStage>
  );
};
return PlatformHingeRise;
}
