...
import { Card, TitleBlock } from '@/compositions/shotcraftLibrary/demos/_fixtures/Fixtures';
    ...
    <AbsoluteFill style={{ background: BG, overflow: 'hidden' }}>
      ...
      >
        <div style={{ position: 'absolute', left: LEFT, top: TOP - 110, opacity: titleLit, filter: 'invert(1)' }}>
          <TitleBlock text={contentText(content, "copy0", "Features")} size={64} />
        </div>
