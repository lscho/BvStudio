...
export function ConceptMapCard({ text, accentColor, timeUs }: CompositionRenderProps) {
...
export function CausalChainCard({ text, accentColor, timeUs }: CompositionRenderProps) {
...
export function ArgumentBoardCard({ text, accentColor, timeUs }: CompositionRenderProps) {
...
export function MythFactCard({ text, accentColor, timeUs }: CompositionRenderProps) {
...
export function QuoteLinesCard({ text, accentColor, timeUs }: CompositionRenderProps) {
  const parts = structuredParts(text);
