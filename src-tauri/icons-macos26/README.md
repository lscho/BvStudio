# BVideo Studio macOS 26 icon set
...
```bash
npm run tauri -- icon src-tauri/app-icon-macos26.svg -o src-tauri/icons-macos26
```

`../app-symbol-macos26.svg` is the simplified monochrome companion mark for small or single-color placements.
